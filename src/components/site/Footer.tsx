  ...
  return (
    <footer className="mt-16 border-t border-border bg-card">
      <div className="container mx-auto grid grid-cols-2 gap-3 px-4 py-8 md:grid-cols-4 md:gap-8 md:py-12">
        ...
        <div>
          <h4 className="mb-3 text-sm font-bold md:text-base">تواصل</h4>
          <ul className="space-y-2 text-xs text-muted-foreground md:text-sm">
            <li>
              <a
                href="https://wa.me/201120373986"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1 rounded-lg bg-[#25D366] px-2 py-2 font-bold text-white transition-colors hover:bg-[#20b858] md:gap-2 md:px-4"
              >
