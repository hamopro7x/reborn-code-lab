        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <div className="flex size-9 items-center justify-center rounded border border-border bg-secondary">
              <span className="text-lg font-semibold text-white">م</span>
            </div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded border border-border bg-card px-4 py-2 text-sm font-medium transition-colors hover:bg-secondary"
              >
