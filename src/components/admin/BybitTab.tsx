...
function CoinBalanceCard({ coin }: { coin: CoinRow }) {
  ...
  return (
    <div dir="ltr" className="relative mx-auto h-[120px] w-full max-w-[240px] shrink-0 rounded-[24px] p-[5px] bg-[radial-gradient(120%_120%_at_50%_0%,oklch(0.55_0.13_170/0.28),transparent_70%)]">
      <div className="relative flex h-full flex-col justify-center overflow-hidden rounded-[20px] bg-[oklch(0.055_0.008_190)] px-5 py-3 shadow-[0_0_28px_-10px_oklch(0.6_0.14_170/0.35)]">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {isUsdt ? (
            ...
            <span className="grid size-[48px] shrink-0 place-items-center rounded-full bg-[oklch(0.18_0.03_285)] border border-border/50">
              <CoinLogo coin={coin.coin} />
            </span>
          )}
        </div>

        <div className="mt-3 text-left text-xs font-medium text-[oklch(0.72_0.12_170)]">
